...
contract3 = Contract.new(company_id: company1.id, individual_id: individual3.id, fully_signed_at: nil, status: "unopened")
...
contract5 = Contract.new(company_id: company2.id, individual_id: individual1.id, fully_signed_at: nil, status: "unopened")
...
contract6 = Contract.new(company_id: company2.id, individual_id: individual2.id, fully_signed_at: nil, status: "unopened")
...
contract7 = Contract.new(company_id: company2.id, individual_id: individual3.id, fully_signed_at: nil, status: "unopened")
...
contract8 = Contract.new(company_id: company2.id, individual_id: individual4.id, fully_signed_at: nil, status: "unopened")
