...
ActiveRecord::Schema.define(version: 2021_11_24_151219) do
  ...
  create_table "contracts", force: :cascade do |t|
    ...
    t.index ["individual_id"], name: "index_contracts_on_individual_id"
  end
  ...
  add_foreign_key "contracts", "individuals"
